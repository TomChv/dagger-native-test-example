...
/**
 * The `ExampleID` scalar type represents an identifier for an object of type Example.
 */
export type ExampleID = string & {__ExampleID: never}
 ...
 * it can be uses as argument to call a exposed function.
 */
function ModuleSourceExperimentalFeatureValueToName(value: ModuleSourceExperimentalFeature): string {
  switch (value) {
 ...
 * it can be properly used inside the module runtime.
 */
function ModuleSourceExperimentalFeatureNameToValue(name: string): ModuleSourceExperimentalFeature {
  switch (name) {
    case "SELF_CALLS":
...
export class Binding extends BaseClient {
  ...
  /**
   * Retrieve the binding value, as type Example
   */
  asExample = (): Example => {
...
export class Env extends BaseClient {
  ...
  /**
   * Create or update a binding of type Example in the environment
   * @param name The name of the binding
   * @param value The Example value to assign to the binding
   * @param description The purpose of the input
   */
  withExampleInput = (name: string, value: Example, description: string): Env => {
  ...
  /**
   * Declare a desired Example output to be assigned in the environment
   * @param name The name of the binding
   * @param description A description of the desired value of the binding
   */
  withExampleOutput = (name: string, description: string): Env => {
...
export class Example extends BaseClient { // example (../../../typescrip-bun/src/index.ts:19:14)
  private readonly _id?: ExampleID = undefined
  private readonly _grepDir?: string = undefined
   ...
   */
   constructor(
    ctx?: Context,
     ...
     this._id = _id
     this._grepDir = _grepDir
   }

  /**
   * A unique identifier for this Example.
   */
  id = async (): Promise<ExampleID> => {
    if (this._id) {
      return this._id
    }
    ...
    const response: Awaited<ExampleID> = await ctx.execute()
   ...
   */
  containerEcho = (stringArg: string): Container => { // example (../../../typescrip-bun/src/index.ts:24:3)
   ...
   */
  grepDir = async (directoryArg: Directory, pattern: string): Promise<string> => { // example (../../../typescrip-bun/src/index.ts:32:9)
    if (this._grepDir) {
      return this._grepDir
    }

    const ctx = this._ctx.select(
      "grepDir",
      { directoryArg, pattern},
    )
...
export class Host extends BaseClient {
  ...
  findUp = async (name: string, 
    opts?: HostFindUpOpts): Promise<string> => {
    if (this._findUp) {
      return this._findUp
    }
...
export class Client extends BaseClient {
  ...
  example = (): Example => { // example (../../../typescrip-bun/src/index.ts:19:14)
  ...
  /**
   * Load a Example from its ID.
   */
  loadExampleFromID = (id: ExampleID): Example => {
