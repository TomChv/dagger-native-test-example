...
func (r *Binding) AsExample() *Example {
	q := r.query.Select("asExample")
...
func (r *Env) WithExampleInput(name string, value *Example, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withExampleInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
func (r *Env) WithExampleOutput(name string, description string) *Env {
	q := r.query.Select("withExampleOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
type Example struct { // example (../../go/main.go:7:6)
	query *querybuilder.Selection

	id *ExampleID
}

func (r *Example) WithGraphQLQuery(q *querybuilder.Selection) *Example {
	return &Example{
		query: q,
	}
}
...
func (r *Example) ContainerEcho(stringArg string) *Container { // example (../../go/main.go:10:1)
...
func (r *Example) ID(ctx context.Context) (ExampleID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response ExampleID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Example) XXX_GraphQLType() string {
	return "Example"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Example) XXX_GraphQLIDType() string {
	return "ExampleID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Example) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Client) Example() *Example { // example (../../go/main.go:7:6)
	q := r.query.Select("example")
...
func (r *Client) LoadExampleFromID(id ExampleID) *Example {
	q := r.query.Select("loadExampleFromID")
	q = q.Arg("id", id)
